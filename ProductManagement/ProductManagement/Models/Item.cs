...
namespace ProductManagement.Models
{
    public class Item : IModel
    {
        ...
        [StringLength(30, ErrorMessage = "Item Code can not be greater than 30")]
        ...
        [StringLength(256, ErrorMessage = "Specification can not be greater than 256")]
        public string specification { get; set; }

        [Display(Name = "Description")]
        [StringLength(64, ErrorMessage = "Description can not be greater than 64")]
        ...
        [StringLength(16, ErrorMessage = "Manufacture Size can not be greater than 16")]
        ...
        [StringLength(16, ErrorMessage = "Manufacture Weight can not be greater than 16")]
        ...
        [StringLength(16, ErrorMessage = "Manufacture Style can not be greater than 16")]
        public string manufacture_style { get; set; }

        [Display(Name = "Manufacture Class")]
        [StringLength(16, ErrorMessage = "Manufacture Class can not be greater than 16")]
        public string manufacture_class { get; set; }

        [Display(Name = "Manufacture Color")]
        [StringLength(16, ErrorMessage = "Manufacture Color can not be greater than 16")]
        public string manufacture_color { get; set; }

        public StaticPagedList<Item> lstItems { get; set; }
    }
}